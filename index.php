...
<body>
  <div class="container">
    <div class="page-title home text-center">
              <span class="heading-page" style="color: white; font-family: 'Poppins'; font-size: 66px;"> Welcome to Kiyowo BookStore
              </span>
            </div>
    <a class="serviceBox" href="products.php" style="text-decoration: none;">
      ...
      <div class="content">
        <h2>Products</h2>
        <p>Create, read, update & delete products to the exisiting product list</p>
      </div>
    </a>
    <a class="serviceBox" href="staffs.php" style="text-decoration: none;">
      <div class="icon" style="--i:#fd6494" href="products.php">
        <ion-icon name="person-outline"></ion-icon>
      </div>
      <div class="content">
        <h2>Staffs</h2>
        <p>Create, read, update & delete staffs to the existing staff list</p>
      </div>
    </a>
    <a class="serviceBox" href="customers.php" style="text-decoration: none;">
      ...
      <div class="content">
        <h2>Customers</h2>
        <p>Create, read, update & delete customers to the existing customer list</p>
      </div>
    </a>
    <a class="serviceBox" href="orders.php" style="text-decoration: none;">
      ...
      <div class="content">
        <h2>Orders</h2>
        <p>Create, read, update & delete orders to the existing order list</p>
      </div>
    </a>
